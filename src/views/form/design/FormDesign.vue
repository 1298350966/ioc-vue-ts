<template>
    <el-row class="process-manage FormDesign" style="padding:15px;">
        <div class="header">
            <span class="header-title">表单管理</span>
            <el-form class="query-form" inline size="small">
                ...
                <el-form-item label="表单名称:">
                    <el-input v-model="nameOrGroup.formName" placeholder="请输入普通表单名称" clearable  @clear="handleQuery"></el-input>
                </el-form-item>
                ...
                <el-form-item label="" prop="">
                    ...
                    <el-button type="info" icon="el-icon-s-tools" @click="formGroupVisible = true">分组管理</el-button>
                    <el-button type="primary" icon="el-icon-plus" @click="handleAdd">创建新表单</el-button>
                    <!-- <el-button type="success" icon="el-icon-download" @click="handleFormExport" plain>批量导出表单</el-button>
                    <el-button type="danger" icon="el-icon-upload2" @click="handleFormImport" plain>导入表单</el-button> -->
                </el-form-item>
                
            </el-form>
        </div>
        <el-row>
            <form-conf-table-tabs :form-type="formType" @handleEdit="handleEdit" :list="listNum"
                             :showManageProcess="true" :nameOrGroup="nameOrGroup"></form-conf-table-tabs>
        </el-row>
        ...
        <FormExportDialog :formExportVisible.sync="formExportVisible"></FormExportDialog>
        <FormImportDialog :formImportVisible.sync="formImportVisible" @handleImportSave="handleImportSave"></FormImportDialog>
    </el-row>
</template>
...
<script>
    ...
    import FormExportDialog from "../export/index.vue";
    import FormImportDialog from "../import/index.vue";
    ...
    export default {
        ...
        methods: {
            ...
            handleFormExport(){
                let _this = this;
                _this.formExportVisible = true;
            },
            // 表单导入
            handleFormImport(){
                let _this = this;
                _this.formImportVisible = true;
            },
            // 导入成功后关闭弹窗，刷新页面
            handleImportSave(val){
                let _this = this;
                _this.handleQuery();
            }
        },

<template>
  <el-timeline style="padding-left: 10px">
    <el-timeline-item v-show="isCharts && dimensionsAndSource" color="#2a2a2b" size="large" :hollow="true" type="info"
      :timestamp="TimelineTitleEnum.MAPPING" placement="top">
      ...
      <el-space direction="horizontal" :fill-ratio="100" fill style="width: 100%">
        ...
        <el-card shadow="never" style="padding: 0">
          <el-scrollbar height="400px">
            <h-code :code="JSON.stringify(source, null, 2)" language="json"></h-code>
          </el-scrollbar>
        </el-card>
      </el-space>
    </el-timeline-item>

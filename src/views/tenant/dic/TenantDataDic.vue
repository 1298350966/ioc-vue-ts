<template>
    <div class="page-container">
            ...
            <el-dialog title="查看字典类目" :visible.sync="dicCatalogFormVisible"
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="类目名称" prop="name">
                                <el-input v-model="dicCatalogForm.name" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="字典类型" >
                                <el-select v-model="typeCode" placeholder="可选择" value="" @change="changeDicCatalog" :disabled="true">
                                    <el-option
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="类目编码" prop="code">
                                <el-input v-model="dicCatalogForm.code" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="排序号">
                                <el-input type="number" v-model="dicCatalogForm.catalogIndex" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
            ...
            <el-dialog title="查看字典类型" :visible.sync="renameFormVisible" :close-on-click-modal="closeOnClickModal"
                       class="custom-dic-dia">
                <el-form :model="dicTypeForm" label-width="120px" :rules="dicTypeFormRules" ref="dicTypeForm">
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="类型名称" prop="typeName">
                                <el-input v-model="dicTypeForm.typeName" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="类型编码" prop="typeCode">
                                <el-input v-model="dicTypeForm.typeCode" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>

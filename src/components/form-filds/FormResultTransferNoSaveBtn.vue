                ...
                <ul class="ty-tree-select">
                    <li v-for="item in targetList">
                        <div class="ty-tree-div">
                            <label class="tyue-checkbox-wrapper">
                                  <span class="tyue-checkbox">
                                      <input type="string" v-model="item.rename" class="tyue-checkbox-input">
...
<script>
    ...
    export default {
        name: "FormResultTransferNoSaveBtn",
        // sourcedata: 源数据集合
        // sourcetitle: 源数据标题
        // targetdata: 目标数据集合
        // targettitle 目标数据标题
        ...
        props: ['sourcedata', 'sourcetitle', 'targetdata', 'targettitle', 'startObj', "closedNotifyNum"],
        watch: {
            targetdata() {
                var source = [];

<template>
  ...
  <el-form-item :label="box.type !== 'text' ? box.name : ''" :prop="box.model">
    ...
    <template v-if="box.type === 'switch'">
      <el-switch v-model="dataModel" :disabled="box.options.disabled"> </el-switch>
    </template>
    ...
    <template v-if="box.type === 'file_upload' || box.type === 'image_upload'">
      ...
      >
        <el-button size="small" type="primary" v-if="box.type === 'image_upload'"
          >图片上传</el-button
        >
        <el-button size="small" type="primary" v-if="box.type === 'file_upload'"
          >附件上传</el-button
        >
      ...
      >
        <div class="demo-image-box" v-for="url in dataModel">
          <el-image style="" :src="url" :preview-src-list="srcObj[box.model]"></el-image>

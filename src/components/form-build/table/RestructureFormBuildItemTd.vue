    ...
    <div>
        ...
        <template v-if="box.type === 'gis_select'">
            ...
            <el-dialog title="地图定位"
                ...
                <Gis v-if="gisMapVisible" :gisType="box.options.gisType" :from-parent-gis-obj="editGisObj"
        ...
        <template
            v-if="box.type === 'org_select' || box.type === 'user_select' || box.type === 'company_select'|| box.type === 'role_select' || box.type === 'dic_select' ">
            <el-input
...
<script>
    ...
    export default {
        name: "RestructureFormBuildItemTd",  // 子表单批量提交时渲染
        // box: 控件配置; (必填)
            ...
            handleSave() {
                ...
                if (_this.box.type === 'data_select' || _this.box.type === 'org_select' || _this.box.type === 'user_select' || _this.box.type === 'company_select' || _this.box.type === 'role_select' || _this.box.type === 'dic_select') {
                   ...
                   /* _this.dataModel = {};
                    ...
                    _this.models[this.box.model] = {};
                    _this.models[this.box.model][this.box.model] = selected[key];
                    _this.models[this.box.model][this.box.label_model] =selected[label];
                                            ...
                                            if (selected[obj.selectKey] instanceof Array && selected[obj.selectKey].length > 0) {
                                                ...
                                                if(col){
                                                    if (col.type == "org_select") {
                                                        //默认取第一个
                                                        let data = array[0];
                                                        _this.models[col.model] = {};
                                                        _this.models[col.model][col.model] = data.id;
                                                        _this.models[col.model][col.label_model] = data.orgName;
                                            ...
                                            if (selected[obj.selectKey] instanceof Array && selected[obj.selectKey].length > 0) {
                                                ...
                                                if(col){
                                                    if (col.type == "role_select") {
                                                        ...
                                                        _this.models[col.model] = {};
                                                        _this.models[col.model][col.model] = data.id;
                                                        _this.models[col.model][col.label_model] = data.roleName;

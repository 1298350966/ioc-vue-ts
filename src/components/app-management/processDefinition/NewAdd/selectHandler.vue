<template>
  <div class="selectHandler">
    ...
    <el-form-item v-if="recipient.type == 2">
      ...
      <p>
        找不到主管时，会抄送到直接主管 <i class="el-icon-warning-outline"></i>
      </p>
    </el-form-item>
...
<script>
import addformcondition from '@/components/app-management/processDefinition/NewAdd/selectHandler/addformcondition'
...
export default {
  props: ["formDataconfig", "recipient",'label'],
  components: {
    addformcondition,
    selectRole,
    selectPeople,

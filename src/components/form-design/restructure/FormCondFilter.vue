...
<script>
    ...
    export default {
        ...
        methods: {
            init() {
                console.log(JSON.stringify(this.itemDataCondFilter));
                console.log('formConfig', JSON.stringify(this.formConfig));

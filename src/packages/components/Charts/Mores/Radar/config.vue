  ...
  <el-collapse>
    ...
    <CollapseItem name="雷达" :expanded="true">
      ...
      <SettingItemBox name="指示器">
        <SettingItem name="颜色">
          <el-color-picker size="small" :modes="['hex']" v-mode="radarConfig.axisName.color"></el-color-picker>
        </SettingItem>
        <SettingItem name="大小">
          <el-input-number v-mode="radarConfig.axisName.fontSize" size="small" :min="9"></el-input-number>
        </SettingItem>
        <SettingItem>
      ...
      <SettingItemBox name="系列" :alone="true">
        <SettingItem name="背景透明度">
          <el-input-number
            v-mode="optionData.series[0].areaStyle.opacity"
            size="small"
            :min="0"
            :max="1"
            :step="0.1"

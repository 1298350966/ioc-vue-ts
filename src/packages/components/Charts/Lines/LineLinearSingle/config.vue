  ...
  <el-collapse>
    ...
    <CollapseItem v-for="(item, index) in seriesList" :key="index" :name="`样式`" :expanded="true">
      <SettingItemBox name="线条">
        <SettingItem name="颜色">
          <el-color-picker size="small" v-model="item.lineStyle.color.colorStops[0].color" show-alpha></el-color-picker>
        </SettingItem>
        <SettingItem name="颜色">
          <el-color-picker size="small" v-model="item.lineStyle.color.colorStops[1].color" show-alpha></el-color-picker>
        </SettingItem>
        <SettingItem name="宽度">
      ...
      <SettingItemBox name="阴影" :alone="true">
        <SettingItem name="颜色">
          <el-color-picker size="small" v-model="item.lineStyle.shadowColor" show-alpha></el-color-picker>
        </SettingItem>

      </SettingItemBox>
      <SettingItemBox name="设置">
        <SettingItem name="阴影">
          <el-button size="small" @click="item.lineStyle.shadowColor = 'rgba(0, 0, 0, 0)'">
            去除阴影
          </el-button>
        </SettingItem>
      </SettingItemBox>

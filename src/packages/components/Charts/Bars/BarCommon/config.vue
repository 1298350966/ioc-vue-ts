<template>
  <el-collapse v-model="collapseActive">
    ...
    <el-collapse-item v-for="(item, index) in seriesList" :key="index" :title="`柱状图-${index + 1}`" :name="index">
      <template #title>
      ...
      <SettingItemBox name="图形">
        <SettingItem name="颜色">
          <el-color-picker size="small" :modes="['hex']" v-model="item.itemStyle.color" show-alpha></el-color-picker>
        </SettingItem>
        <SettingItem>

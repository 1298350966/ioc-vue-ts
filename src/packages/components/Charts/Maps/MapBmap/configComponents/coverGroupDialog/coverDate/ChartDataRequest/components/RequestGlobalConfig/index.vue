<template>
  ...
  <el-card class="n-card-shallow">
    ...
    <!-- 箭头 -->
    <div v-if="showTable" class="kh-flex-center go-mt-3 down" @click="showTable = false">
      <el-icon size="32">
        <chevron-up-outline-icon />
      </el-icon>
    </div>
    <div v-else class="kh-flex-center go-mt-3 down" @click="showTable = true">

...
import CircleData from "../../json/CircleData.json";
...
function typeChange(type) {
  switch (type) {
    ...
    case coverEnum.Circle:
      ...
      props.config.data = cloneDeep(CircleData);
...
onMounted(() => {
  switch (props.config.type) {
    case coverEnum.Marker:
      commentName.value = markRaw(MarkerConfig);
      break;
    case coverEnum.Circle:
      commentName.value = markRaw(CircleConfig);
      break;
    case coverEnum.Polygon:
      commentName.value = markRaw(PolygonConfig);
      break;
    case coverEnum.Polyline:
      commentName.value = markRaw(PolylineConfig);
      break;
    default:
      break;
  }

    ...
    <collapse-item name="样式" :expanded="true">
      <setting-item-box name="文字">
        ...
        <setting-item name="水平对齐">
          <el-select-v2 v-model="optionData.textAlign" size="small" :options="textAlignOptions" />
        </setting-item>
        <setting-item name="文本方向">
          <el-select-v2 v-model="optionData.writingMode" size="small" :options="verticalOptions" />
        </setting-item>
      ...
      <setting-item-box name="边框">
        <setting-item name="宽度">
          <el-input-number
            v-model="optionData.borderWidth"
            size="small"
            :min="0"
            placeholder="宽度"
          ></el-input-number>

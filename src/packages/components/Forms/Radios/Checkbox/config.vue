  ...
  <el-collapse>
    <collapse-item name="配置" :expanded="true">
      <setting-item-box name="默认值" :alone="true">
        <setting-item>
          <el-select-v2 v-model="optionData.modelValue" size="small" :options="optionList" multiple clearable></el-select-v2>
        </setting-item>
      </setting-item-box>
      <setting-item-box name="是否禁用">
        <setting-item >
          <el-switch v-model="optionData.attrs.disabled" size="small" />
        </setting-item>
      </setting-item-box>
      <setting-item-box name="颜色">
        <setting-item name="活跃时字体颜色">
          <el-color-picker
              size="small"
              v-model="optionData.attrs.textColor"
              show-alpha
          ></el-color-picker>
        </setting-item>
        <setting-item name="活跃时边框和背景色">
          <el-color-picker
              size="small"
              v-model="optionData.attrs.fill"
              show-alpha
          ></el-color-picker>
        </setting-item>
      </setting-item-box>
